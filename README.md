...
Below is an example of a score generated using a sequence produced by the algorithm, rendered with the `musicntwrk` library by [@marcobn](https://github.com/marcobn).

<!-- Replace this image with your own -->

![Example Score](example.png)
